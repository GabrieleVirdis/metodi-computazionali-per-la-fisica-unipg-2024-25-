...
# Lista con gioni della settimana nel mese di ottobre 2024
ottobre = week[1:]+week*3+week[:4]

print(ottobre)


# Dizionario ottobre 2024 per giorno del mese e della settimana (metodo base)
dict_ottobre = {}
...
# Dizionario ottobre 2024 per giorno del mese e della settimana (metodo con list comprehension)
